...
public class InfluxDBTLPWhereOracle<G extends SQLGlobalState<?, S>, S extends AbstractSchema<?, T>, T extends AbstractTable<C, ?, ?>, C extends AbstractTableColumn<?, ?>, Z extends Select<J, E, T, C>, J extends Join<E, T, C>, E extends Expression<C>>
        implements TestOracle<InfluxDBProvider.InfluxDBGlobalState> {

    private final InfluxDBProvider.InfluxDBGlobalState state;
    private TLPWhereGenerator<Z, J, E, T, C> gen;
    private final ExpectedErrors errors;
    private Reproducer<InfluxDBProvider.InfluxDBGlobalState> reproducer;
    private String generatedQueryString;

    private class TLPWhereReproducer implements Reproducer<InfluxDBProvider.InfluxDBGlobalState> {
        ...
        @Override
        public boolean bugStillTriggers(InfluxDBProvider.InfluxDBGlobalState globalState) {
            try {
    ...
    public InfluxDBTLPWhereOracle(InfluxDBProvider.InfluxDBGlobalState state,
                                  TLPWhereGenerator<Z, J, E, T, C> gen,
    ...
    @Override
    public Reproducer<InfluxDBProvider.InfluxDBGlobalState> getLastReproducer() {
        return reproducer;
    }
